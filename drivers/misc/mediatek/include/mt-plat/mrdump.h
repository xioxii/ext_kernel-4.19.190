...
struct mrdump_bank_info {
    char sig[8];
    uint64_t bank_apv_md1rom_ba;
    uint64_t bank_mdv_md1rom_ba;
    uint64_t bank_apv_md_smem_cache_ba;
    uint64_t bank_mdv_md_smem_cache_ba;
    uint64_t bank_apv_md_smem_ncache_ba;
    uint64_t bank_mdv_md_smem_ncache_ba;
};
...
struct mrdump_control_block {
	...
	struct mrdump_bank_info bank_info;
};
