...
{
	static u32 regs[] = {
		0x14000100,	/* mmsys MMSYS_CG_CON0 read/write 32 bit*/
		0x112300a0,	/* msdc0 SW_DBG_SEL  can read/write 16 bit*/
		0x1121004c,	/* audio AFE_I2S_CON3_OFFSET can read/write 32 bit*/
		0x110020bc,	/* uart0 SPM_SEL can read/write 1 bit*/
	};
