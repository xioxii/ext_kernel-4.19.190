...
#define SPM_RESOURCE_ACK_CON4          (SPM_BASE + 0x03C)
...
#define NETSYS_CLK_MUX_SEL             (SPM_BASE + 0x054)
#define PCIE_CLK_MUX_SEL               (SPM_BASE + 0x058)
#define PCIE_SW_LOCK                   (SPM_BASE + 0x05C)
#define NETSYS_CKSEL_EN                (SPM_BASE + 0x060)
#define NETSYS_PLL_CON                 (SPM_BASE + 0x064)
...
#define GCPU_SRAM_CON                  (SPM_BASE + 0x3AC)
...
#define RC_SPMIF_CON                   (SPM_BASE + 0x570)
#define RC_SPMIF_RDATA                 (SPM_BASE + 0x57C)
...
#define REG_PCIE1_ACTIVE_SRCCLKENA_MASK_B_LSB (1U << 5)       /* 1b */
#define REG_PCIE1_ACTIVE_INFRA_REQ_MASK_B_LSB (1U << 6)       /* 1b */
#define REG_PCIE1_ACTIVE_APSRC_REQ_MASK_B_LSB (1U << 7)       /* 1b */
#define REG_PCIE1_ACTIVE_VRF18_REQ_MASK_B_LSB (1U << 8)       /* 1b */
#define REG_PCIE1_ACTIVE_DDR_EN_MASK_B_LSB  (1U << 9)       /* 1b */
#define REG_PCIE2_ACTIVE_SRCCLKENA_MASK_B_LSB (1U << 10)      /* 1b */
#define REG_PCIE2_ACTIVE_INFRA_REQ_MASK_B_LSB (1U << 11)      /* 1b */
#define REG_PCIE2_ACTIVE_APSRC_REQ_MASK_B_LSB (1U << 12)      /* 1b */
#define REG_PCIE2_ACTIVE_VRF18_REQ_MASK_B_LSB (1U << 13)      /* 1b */
#define REG_PCIE2_ACTIVE_DDR_EN_MASK_B_LSB  (1U << 14)      /* 1b */
#define REG_PCIE3_ACTIVE_SRCCLKENA_MASK_B_LSB (1U << 15)      /* 1b */
#define REG_PCIE3_ACTIVE_INFRA_REQ_MASK_B_LSB (1U << 16)      /* 1b */
#define REG_PCIE3_ACTIVE_APSRC_REQ_MASK_B_LSB (1U << 17)      /* 1b */
#define REG_PCIE3_ACTIVE_VRF18_REQ_MASK_B_LSB (1U << 18)      /* 1b */
#define REG_PCIE3_ACTIVE_DDR_EN_MASK_B_LSB  (1U << 19)      /* 1b */
#define REG_PCIE1_SRCCLKENA_MASK_B_LSB      (1U << 20)      /* 1b */
#define REG_PCIE1_INFRA_REQ_MASK_B_LSB      (1U << 21)      /* 1b */
#define REG_PCIE1_APSRC_REQ_MASK_B_LSB      (1U << 22)      /* 1b */
#define REG_PCIE1_VRF18_REQ_MASK_B_LSB      (1U << 23)      /* 1b */
#define REG_PCIE1_DDR_EN_MASK_B_LSB         (1U << 24)      /* 1b */
#define REG_PCIE2_SRCCLKENA_MASK_B_LSB      (1U << 25)      /* 1b */
#define REG_PCIE2_INFRA_REQ_MASK_B_LSB      (1U << 26)      /* 1b */
#define REG_PCIE2_APSRC_REQ_MASK_B_LSB      (1U << 27)      /* 1b */
#define REG_PCIE2_VRF18_REQ_MASK_B_LSB      (1U << 28)      /* 1b */
#define REG_PCIE2_DDR_EN_MASK_B_LSB         (1U << 29)      /* 1b */
#define REG_PCIE3_SRCCLKENA_MASK_B_LSB      (1U << 30)      /* 1b */
#define REG_PCIE3_INFRA_REQ_MASK_B_LSB      (1U << 31)      /* 1b */
/* SPM_RESOURCE_ACK_CON4 (0x10006000+0x03C) */
#define REG_PCIE1_ACTIVE_SRCCLKENA_ACK_MASK_LSB (1U << 0)       /* 1b */
#define REG_PCIE1_ACTIVE_INFRA_ACK_MASK_LSB (1U << 1)       /* 1b */
#define REG_PCIE1_ACTIVE_APSRC_ACK_MASK_LSB (1U << 2)       /* 1b */
#define REG_PCIE1_ACTIVE_VRF18_ACK_MASK_LSB (1U << 3)       /* 1b */
#define REG_PCIE1_ACTIVE_DDR_EN_ACK_MASK_LSB (1U << 4)       /* 1b */
#define REG_PCIE2_ACTIVE_SRCCLKENA_ACK_MASK_LSB (1U << 5)       /* 1b */
#define REG_PCIE2_ACTIVE_INFRA_ACK_MASK_LSB (1U << 6)       /* 1b */
#define REG_PCIE2_ACTIVE_APSRC_ACK_MASK_LSB (1U << 7)       /* 1b */
#define REG_PCIE2_ACTIVE_VRF18_ACK_MASK_LSB (1U << 8)       /* 1b */
#define REG_PCIE2_ACTIVE_DDR_EN_ACK_MASK_LSB (1U << 9)       /* 1b */
#define REG_PCIE3_ACTIVE_SRCCLKENA_ACK_MASK_LSB (1U << 10)      /* 1b */
#define REG_PCIE3_ACTIVE_INFRA_ACK_MASK_LSB (1U << 11)      /* 1b */
#define REG_PCIE3_ACTIVE_APSRC_ACK_MASK_LSB (1U << 12)      /* 1b */
#define REG_PCIE3_ACTIVE_VRF18_ACK_MASK_LSB (1U << 13)      /* 1b */
#define REG_PCIE3_ACTIVE_DDR_EN_ACK_MASK_LSB (1U << 14)      /* 1b */
#define REG_PCIE1_SRCCLKENA_ACK_MASK_LSB    (1U << 15)      /* 1b */
#define REG_PCIE1_INFRA_ACK_MASK_LSB        (1U << 16)      /* 1b */
#define REG_PCIE1_APSRC_ACK_MASK_LSB        (1U << 17)      /* 1b */
#define REG_PCIE1_VRF18_ACK_MASK_LSB        (1U << 18)      /* 1b */
#define REG_PCIE1_DDR_EN_ACK_MASK_LSB       (1U << 19)      /* 1b */
#define REG_PCIE2_SRCCLKENA_ACK_MASK_LSB    (1U << 20)      /* 1b */
#define REG_PCIE2_INFRA_ACK_MASK_LSB        (1U << 21)      /* 1b */
#define REG_PCIE2_APSRC_ACK_MASK_LSB        (1U << 22)      /* 1b */
#define REG_PCIE2_VRF18_ACK_MASK_LSB        (1U << 23)      /* 1b */
#define REG_PCIE2_DDR_EN_ACK_MASK_LSB       (1U << 24)      /* 1b */
#define REG_PCIE3_SRCCLKENA_ACK_MASK_LSB    (1U << 25)      /* 1b */
#define REG_PCIE3_INFRA_ACK_MASK_LSB        (1U << 26)      /* 1b */
#define REG_PCIE3_APSRC_ACK_MASK_LSB        (1U << 27)      /* 1b */
#define REG_PCIE3_VRF18_ACK_MASK_LSB        (1U << 28)      /* 1b */
#define REG_PCIE3_DDR_EN_ACK_MASK_LSB       (1U << 29)      /* 1b */
#define REG_CLDMA_SRCCLKENA_ACK_MASK_LSB    (1U << 30)      /* 1b */
#define REG_CLDMA_INFRA_ACK_MASK_LSB        (1U << 31)      /* 1b */
...
/* NETSYS_CLK_MUX_SEL (0x10006000+0x54) */
#define SC_NETSYS_CLK_MUX_SEL_LSB           (1U << 0)       /* 12b */
/* PCIE_CLK_MUX_SEL (0x10006000+0x58) */
#define SC_PCIE_CLK_MUX_SEL_LSB             (1U << 0)       /* 2b */
#define SC_PCIE_REF_CLK_MUX_SEL_LSB         (1U << 4)       /* 1b */
/* PCIE_SW_LOCK (0x10006000+0x5C) */
#define SC_PCIE_SW_LOCK_LSB                 (1U << 0)       /* 1b */
#define SC_PCIE_SW_LOCK_SPM_SEL_LSB         (1U << 1)       /* 1b */
/* NETSYS_CKSEL_EN (0x10006000+0x60) */
#define SC_NETSYS_CKSEL_EN_LSB              (1U << 0)       /* 1b */
/* NETSYS_PLL_CON (0x10006000+0x64) */
#define SC_NETSYSPLL_PWR_OFF_LSB            (1U << 0)       /* 1b */
#define SC_NETSYSPLL_OFF_LSB                (1U << 1)       /* 1b */
#define SC_NETSYSPLL_OUTOFF_LSB             (1U << 2)       /* 1b */
#define SC_NETSYSPLL_FHC_PAUSE_LSB          (1U << 3)       /* 1b */
#define SC_NET2PLL_PWR_OFF_LSB              (1U << 4)       /* 1b */
#define SC_NET2PLL_OFF_LSB                  (1U << 5)       /* 1b */
#define SC_NET2PLL_OUTOFF_LSB               (1U << 6)       /* 1b */
#define SC_NET2PLL_FHC_PAUSE_LSB            (1U << 7)       /* 1b */
#define SC_WEDMCUPLL_PWR_OFF_LSB            (1U << 8)       /* 1b */
#define SC_WEDMCUPLL_OFF_LSB                (1U << 9)       /* 1b */
#define SC_WEDMCUPLL_OUTOFF_LSB             (1U << 10)      /* 1b */
#define SC_WEDMCUPLL_FHC_PAUSE_LSB          (1U << 11)      /* 1b */
#define SC_MEDMCUPLL_PWR_OFF_LSB            (1U << 12)      /* 1b */
#define SC_MEDMCUPLL_OFF_LSB                (1U << 13)      /* 1b */
#define SC_MEDMCUPLL_OUTOFF_LSB             (1U << 14)      /* 1b */
#define SC_MEDMCUPLL_FHC_PAUSE_LSB          (1U << 15)      /* 1b */
...
#define REG_NETSYS_SRCCLKENA_MASK_B_LSB     (1U << 5)       /* 1b */
#define REG_NETSYS_INFRA_REQ_MASK_B_LSB     (1U << 6)       /* 1b */
#define REG_NETSYS_APSRC_REQ_MASK_B_LSB     (1U << 7)       /* 1b */
#define REG_NETSYS_VRF18_REQ_MASK_B_LSB     (1U << 8)       /* 1b */
#define REG_NETSYS_DDR_EN_MASK_B_LSB        (1U << 9)       /* 1b */
...
#define REG_USB_SRCCLKENA_MASK_B_LSB        (1U << 23)      /* 1b */
#define REG_USB_INFRA_REQ_MASK_B_LSB        (1U << 24)      /* 1b */
#define REG_USB_APSRC_REQ_MASK_B_LSB        (1U << 25)      /* 1b */
#define REG_USB_VRF18_REQ_MASK_B_LSB        (1U << 26)      /* 1b */
#define REG_USB_DDR_EN_MASK_B_LSB           (1U << 27)      /* 1b */
...
#define REG_AUDIO_SRCCLKENA_MASK_B_LSB      (1U << 16)      /* 1b */
#define REG_AUDIO_INFRA_REQ_MASK_B_LSB      (1U << 17)      /* 1b */
#define REG_AUDIO_APSRC_REQ_MASK_B_LSB      (1U << 18)      /* 1b */
#define REG_AUDIO_VRF18_REQ_MASK_B_LSB      (1U << 19)      /* 1b */
#define REG_AUDIO_DDR_EN_MASK_B_LSB         (1U << 20)      /* 1b */
...
#define REG_CLDMA_SRCCLKENA_MASK_B_LSB      (1U << 28)      /* 1b */
#define REG_CLDMA_INFRA_REQ_MASK_B_LSB      (1U << 29)      /* 1b */
#define REG_CLDMA_APSRC_REQ_MASK_B_LSB      (1U << 30)      /* 1b */
#define REG_CLDMA_VRF18_REQ_MASK_B_LSB      (1U << 31)      /* 1b */
...
#define REG_PCIE_ACTIVE_SRCCLKENA_MASK_B_LSB (1U << 18)      /* 1b */
#define REG_PCIE_ACTIVE_INFRA_REQ_MASK_B_LSB (1U << 19)      /* 1b */
#define REG_PCIE_ACTIVE_APSRC_REQ_MASK_B_LSB (1U << 20)      /* 1b */
#define REG_PCIE_ACTIVE_VRF18_REQ_MASK_B_LSB (1U << 21)      /* 1b */
#define REG_PCIE_ACTIVE_DDR_EN_MASK_B_LSB   (1U << 22)      /* 1b */
...
#define REG_PCIE3_DDR_EN_MASK_B_LSB         (1U << 28)      /* 1b */
#define REG_PCIE3_APSRC_REQ_MASK_B_LSB      (1U << 30)      /* 1b */
#define REG_PCIE3_VRF18_REQ_MASK_B_LSB      (1U << 31)      /* 1b */
...
#define REG_NETSYS_SRCCLKENA_ACK_MASK_LSB   (1U << 25)      /* 1b */
#define REG_NETSYS_INFRA_ACK_MASK_LSB       (1U << 26)      /* 1b */
#define REG_NETSYS_APSRC_ACK_MASK_LSB       (1U << 27)      /* 1b */
#define REG_NETSYS_VRF18_ACK_MASK_LSB       (1U << 28)      /* 1b */
#define REG_NETSYS_DDR_EN_ACK_MASK_LSB      (1U << 29)      /* 1b */
...
#define REG_USB_SRCCLKENA_ACK_MASK_LSB      (1U << 5)       /* 1b */
#define REG_USB_INFRA_ACK_MASK_LSB          (1U << 6)       /* 1b */
#define REG_USB_APSRC_ACK_MASK_LSB          (1U << 7)       /* 1b */
#define REG_USB_VRF18_ACK_MASK_LSB          (1U << 8)       /* 1b */
#define REG_USB_DDR_EN_ACK_MASK_LSB         (1U << 9)       /* 1b */
...
#define REG_CLDMA_DDR_EN_MASK_B_LSB         (1U << 31)      /* 1b */
...
#define REG_AUDIO_SRCCLKENA_ACK_MASK_LSB    (1U << 8)       /* 1b */
#define REG_AUDIO_INFRA_ACK_MASK_LSB        (1U << 9)       /* 1b */
#define REG_AUDIO_APSRC_ACK_MASK_LSB        (1U << 10)      /* 1b */
#define REG_AUDIO_VRF18_ACK_MASK_LSB        (1U << 11)      /* 1b */
#define REG_AUDIO_DDR_EN_ACK_MASK_LSB       (1U << 12)      /* 1b */
#define REG_PCIE_ACTIVE_SRCCLKENA_ACK_MASK_LSB (1U << 13)      /* 1b */
#define REG_PCIE_ACTIVE_INFRA_ACK_MASK_LSB  (1U << 14)      /* 1b */
#define REG_PCIE_ACTIVE_APSRC_ACK_MASK_LSB  (1U << 15)      /* 1b */
#define REG_PCIE_ACTIVE_VRF18_ACK_MASK_LSB  (1U << 16)      /* 1b */
#define REG_PCIE_ACTIVE_DDR_EN_ACK_MASK_LSB (1U << 17)      /* 1b */
...
#define REG_CLDMA_APSRC_ACK_MASK_LSB        (1U << 28)      /* 1b */
#define REG_CLDMA_VRF18_ACK_MASK_LSB        (1U << 29)      /* 1b */
#define REG_CLDMA_DDR_EN_ACK_MASK_LSB       (1U << 30)      /* 1b */
...
#define NETSYS_SRCCLKENA_LSB                (1U << 5)       /* 1b */
#define NETSYS_INFRA_REQ_LSB                (1U << 6)       /* 1b */
#define NETSYS_APSRC_REQ_LSB                (1U << 7)       /* 1b */
#define NETSYS_VRF18_REQ_LSB                (1U << 8)       /* 1b */
#define NETSYS_DDR_EN_LSB                   (1U << 9)       /* 1b */
...
#define USB_SRCCLKENA_LSB                   (1U << 0)       /* 1b */
#define USB_INFRA_REQ_LSB                   (1U << 1)       /* 1b */
#define USB_APSRC_REQ_LSB                   (1U << 2)       /* 1b */
#define USB_VRF18_REQ_LSB                   (1U << 3)       /* 1b */
#define USB_DDR_EN_LSB                      (1U << 4)       /* 1b */
#define AUDIO_SRCCLKENA_LSB                 (1U << 5)       /* 1b */
#define AUDIO_INFRA_REQ_LSB                 (1U << 6)       /* 1b */
#define AUDIO_APSRC_REQ_LSB                 (1U << 7)       /* 1b */
#define AUDIO_VRF18_REQ_LSB                 (1U << 8)       /* 1b */
#define AUDIO_DDR_EN_LSB                    (1U << 9)       /* 1b */
#define PCIE_ACTIVE_REQ_LSB                 (1U << 10)      /* 1b */
#define PCIE_MAC_WAKE_LSB                   (1U << 11)      /* 1b */
#define PCIE1_ACTIVE_REQ_LSB                (1U << 12)      /* 1b */
#define PCIE1_MAC_WAKE_LSB                  (1U << 13)      /* 1b */
#define PCIE2_ACTIVE_REQ_LSB                (1U << 14)      /* 1b */
#define PCIE2_MAC_WAKE_LSB                  (1U << 15)      /* 1b */
#define PCIE3_ACTIVE_REQ_LSB                (1U << 16)      /* 1b */
#define PCIE3_MAC_WAKE_LSB                  (1U << 17)      /* 1b */
#define DPMAIF_SRCCLKENA_LSB                (1U << 18)      /* 1b */
#define DPMAIF_INFRA_REQ_LSB                (1U << 19)      /* 1b */
#define DPMAIF_APSRC_REQ_LSB                (1U << 20)      /* 1b */
#define DPMAIF_VRF18_REQ_LSB                (1U << 21)      /* 1b */
#define DPMAIF_DDR_EN_LSB                   (1U << 22)      /* 1b */
#define CLDMA_REQ_LSB                       (1U << 23)      /* 1b */
...
#define MFG1_SRAM_PDN_LSB                   (1U << 9)       /* 1b */
#define SC_MFG0_SRAM_PDN_ACK_LSB            (1U << 12)      /* 1b */
/* PEXTP_D_2LX1_PHY_PWR_CON (0x10006000+0x30C) */
#define PEXTP_D_2LX1_PHY_PWR_RST_B_LSB      (1U << 0)       /* 1b */
#define PEXTP_D_2LX1_PHY_PWR_ISO_LSB        (1U << 1)       /* 1b */
#define PEXTP_D_2LX1_PHY_PWR_ON_LSB         (1U << 2)       /* 1b */
#define PEXTP_D_2LX1_PHY_PWR_ON_2ND_LSB     (1U << 3)       /* 1b */
#define PEXTP_D_2LX1_PHY_PWR_CLK_DIS_LSB    (1U << 4)       /* 1b */
/* PEXTP_R_2LX1_PHY_PWR_CON (0x10006000+0x310) */
#define PEXTP_R_2LX1_PHY_PWR_RST_B_LSB      (1U << 0)       /* 1b */
#define PEXTP_R_2LX1_PHY_PWR_ISO_LSB        (1U << 1)       /* 1b */
#define PEXTP_R_2LX1_PHY_PWR_ON_LSB         (1U << 2)       /* 1b */
#define PEXTP_R_2LX1_PHY_PWR_ON_2ND_LSB     (1U << 3)       /* 1b */
#define PEXTP_R_2LX1_PHY_PWR_CLK_DIS_LSB    (1U << 4)       /* 1b */
/* PEXTP_R_1LX2_0P_PHY_PWR_CON (0x10006000+0x314) */
#define PEXTP_R_1LX2_0P_PHY_PWR_RST_B_LSB   (1U << 0)       /* 1b */
#define PEXTP_R_1LX2_0P_PHY_PWR_ISO_LSB     (1U << 1)       /* 1b */
#define PEXTP_R_1LX2_0P_PHY_PWR_ON_LSB      (1U << 2)       /* 1b */
#define PEXTP_R_1LX2_0P_PHY_PWR_ON_2ND_LSB  (1U << 3)       /* 1b */
#define PEXTP_R_1LX2_0P_PHY_PWR_CLK_DIS_LSB (1U << 4)       /* 1b */
/* PEXTP_R_1LX2_1P_PHY_PWR_CON (0x10006000+0x318) */
#define PEXTP_R_1LX2_1P_PHY_PWR_RST_B_LSB   (1U << 0)       /* 1b */
#define PEXTP_R_1LX2_1P_PHY_PWR_ISO_LSB     (1U << 1)       /* 1b */
#define PEXTP_R_1LX2_1P_PHY_PWR_ON_LSB      (1U << 2)       /* 1b */
#define PEXTP_R_1LX2_1P_PHY_PWR_ON_2ND_LSB  (1U << 3)       /* 1b */
#define PEXTP_R_1LX2_1P_PHY_PWR_CLK_DIS_LSB (1U << 4)       /* 1b */
/* SSUSB_PHY_PWR_CON (0x10006000+0x31C) */
...
/* EIP97_PWR_CON (0x10006000+0x328) */
#define EIP97_PWR_RST_B_LSB                 (1U << 0)       /* 1b */
#define EIP97_PWR_ISO_LSB                   (1U << 1)       /* 1b */
#define EIP97_PWR_ON_LSB                    (1U << 2)       /* 1b */
#define EIP97_PWR_ON_2ND_LSB                (1U << 3)       /* 1b */
#define EIP97_PWR_CLK_DIS_LSB               (1U << 4)       /* 1b */
#define EIP97_SRAM_PDN_LSB                  (1U << 8)       /* 1b */
...
/* PEXTP_D_2LX1_PWR_CON (0x10006000+0x330) */
#define PEXTP_D_2LX1_PWR_RST_B_LSB          (1U << 0)       /* 1b */
#define PEXTP_D_2LX1_PWR_ISO_LSB            (1U << 1)       /* 1b */
#define PEXTP_D_2LX1_PWR_ON_LSB             (1U << 2)       /* 1b */
#define PEXTP_D_2LX1_PWR_ON_2ND_LSB         (1U << 3)       /* 1b */
#define PEXTP_D_2LX1_PWR_CLK_DIS_LSB        (1U << 4)       /* 1b */
#define PEXTP_D_2LX1_SRAM_PDN_LSB           (1U << 8)       /* 1b */
#define SC_PEXTP_D_2LX1_SRAM_PDN_ACK_LSB    (1U << 12)      /* 1b */
/* PEXTP_R_2LX1_PWR_CON (0x10006000+0x334) */
#define PEXTP_R_2LX1_PWR_RST_B_LSB          (1U << 0)       /* 1b */
#define PEXTP_R_2LX1_PWR_ISO_LSB            (1U << 1)       /* 1b */
#define PEXTP_R_2LX1_PWR_ON_LSB             (1U << 2)       /* 1b */
#define PEXTP_R_2LX1_PWR_ON_2ND_LSB         (1U << 3)       /* 1b */
#define PEXTP_R_2LX1_PWR_CLK_DIS_LSB        (1U << 4)       /* 1b */
#define PEXTP_R_2LX1_SRAM_PDN_LSB           (1U << 8)       /* 1b */
#define SC_PEXTP_R_2LX1_SRAM_PDN_ACK_LSB    (1U << 12)      /* 1b */
/* PEXTP_R_1LX2_PWR_CON (0x10006000+0x338) */
#define PEXTP_R_1LX2_PWR_RST_B_LSB          (1U << 0)       /* 1b */
#define PEXTP_R_1LX2_PWR_ISO_LSB            (1U << 1)       /* 1b */
#define PEXTP_R_1LX2_PWR_ON_LSB             (1U << 2)       /* 1b */
#define PEXTP_R_1LX2_PWR_ON_2ND_LSB         (1U << 3)       /* 1b */
#define PEXTP_R_1LX2_PWR_CLK_DIS_LSB        (1U << 4)       /* 1b */
#define PEXTP_R_1LX2_SRAM_PDN_LSB           (1U << 8)       /* 1b */
#define SC_PEXTP_R_1LX2_SRAM_PDN_ACK_LSB    (1U << 12)      /* 1b */
/* ETH_PWR_CON (0x10006000+0x33C) */
#define ETH_PWR_RST_B_LSB                   (1U << 0)       /* 1b */
#define ETH_PWR_ISO_LSB                     (1U << 1)       /* 1b */
#define ETH_PWR_ON_LSB                      (1U << 2)       /* 1b */
#define ETH_PWR_ON_2ND_LSB                  (1U << 3)       /* 1b */
#define ETH_PWR_CLK_DIS_LSB                 (1U << 4)       /* 1b */
#define ETH_SRAM_PDN_LSB                    (1U << 8)       /* 1b */
#define SC_ETH_SRAM_PDN_ACK_LSB             (1U << 12)      /* 1b */
/* SSUSB_PWR_CON (0x10006000+0x340) */
...
/* HSMTOP_PWR_CON (0x10006000+0x344) */
#define HSMTOP_PWR_RST_B_LSB                (1U << 0)       /* 1b */
#define HSMTOP_PWR_ISO_LSB                  (1U << 1)       /* 1b */
#define HSMTOP_PWR_ON_LSB                   (1U << 2)       /* 1b */
#define HSMTOP_PWR_ON_2ND_LSB               (1U << 3)       /* 1b */
#define HSMTOP_PWR_CLK_DIS_LSB              (1U << 4)       /* 1b */
#define HSMTOP_SRAM_CKISO_LSB               (1U << 5)       /* 1b */
#define HSMTOP_SRAM_ISOINT_B_LSB            (1U << 6)       /* 1b */
#define HSMTOP_SRAM_PDN_LSB                 (1U << 8)       /* 1b */
#define HSMTOP_SRAM_SLEEP_B_LSB             (1U << 9)       /* 1b */
#define SC_HSMTOP_SRAM_PDN_ACK_LSB          (1U << 12)      /* 1b */
#define SC_HSMTOP_SRAM_SLEEP_B_ACK_LSB      (1U << 13)      /* 1b */
/* NETSYS_PWR_CON (0x10006000+0x34C) */
#define NETSYS_PWR_RST_B_LSB                (1U << 0)       /* 1b */
#define NETSYS_PWR_ISO_LSB                  (1U << 1)       /* 1b */
#define NETSYS_PWR_ON_LSB                   (1U << 2)       /* 1b */
#define NETSYS_PWR_ON_2ND_LSB               (1U << 3)       /* 1b */
#define NETSYS_PWR_CLK_DIS_LSB              (1U << 4)       /* 1b */
#define NETSYS_SRAM_PDN_LSB                 (1U << 8)       /* 1b */
...
/* SGMII_0_PHY_PWR_CON (0x10006000+0x358) */
#define SGMII_0_PHY_PWR_RST_B_LSB           (1U << 0)       /* 1b */
#define SGMII_0_PHY_PWR_ISO_LSB             (1U << 1)       /* 1b */
#define SGMII_0_PHY_PWR_ON_LSB              (1U << 2)       /* 1b */
#define SGMII_0_PHY_PWR_ON_2ND_LSB          (1U << 3)       /* 1b */
#define SGMII_0_PHY_PWR_CLK_DIS_LSB         (1U << 4)       /* 1b */
/* SGMII_1_PHY_PWR_CON (0x10006000+0x35C) */
#define SGMII_1_PHY_PWR_RST_B_LSB           (1U << 0)       /* 1b */
#define SGMII_1_PHY_PWR_ISO_LSB             (1U << 1)       /* 1b */
#define SGMII_1_PHY_PWR_ON_LSB              (1U << 2)       /* 1b */
#define SGMII_1_PHY_PWR_ON_2ND_LSB          (1U << 3)       /* 1b */
#define SGMII_1_PHY_PWR_CLK_DIS_LSB         (1U << 4)       /* 1b */
/* SGMII_0_TOP_PWR_CON (0x10006000+0x360) */
#define SGMII_0_TOP_PWR_RST_B_LSB           (1U << 0)       /* 1b */
#define SGMII_0_TOP_PWR_ISO_LSB             (1U << 1)       /* 1b */
#define SGMII_0_TOP_PWR_ON_LSB              (1U << 2)       /* 1b */
#define SGMII_0_TOP_PWR_ON_2ND_LSB          (1U << 3)       /* 1b */
#define SGMII_0_TOP_PWR_CLK_DIS_LSB         (1U << 4)       /* 1b */
/* SGMII_1_TOP_PWR_CON (0x10006000+0x364) */
#define SGMII_1_TOP_PWR_RST_B_LSB           (1U << 0)       /* 1b */
#define SGMII_1_TOP_PWR_ISO_LSB             (1U << 1)       /* 1b */
#define SGMII_1_TOP_PWR_ON_LSB              (1U << 2)       /* 1b */
#define SGMII_1_TOP_PWR_ON_2ND_LSB          (1U << 3)       /* 1b */
#define SGMII_1_TOP_PWR_CLK_DIS_LSB         (1U << 4)       /* 1b */
/* DRAMC_MD32_PWR_CON (0x10006000+0x368) */
...
#define SYSRAM_SRAM_SLEEP_B_LSB             (1U << 4)       /* 6b */
#define SYSRAM_SRAM_PDN_LSB                 (1U << 16)      /* 6b */
/* SYSROM_CON (0x10006000+0x370) */
#define SYSROM_SRAM_PDN_LSB                 (1U << 0)       /* 12b */
...
#define SSPM_SRAM_SLEEP_B_ACK_LSB           (1U << 12)      /* 1b */
#define SSPM_SRAM_PDN_LSB                   (1U << 16)      /* 1b */
#define SSPM_SRAM_PDN_ACK_LSB               (1U << 24)      /* 1b */
/* NETSYS_S_SRAM_CON (0x10006000+0x378) */
#define NETSYS_S_SRAM_CKISO_LSB             (1U << 0)       /* 1b */
#define NETSYS_S_SRAM_ISOINT_B_LSB          (1U << 1)       /* 1b */
#define NETSYS_S_SRAM_SLEEP_B_LSB           (1U << 4)       /* 1b */
#define NETSYS_S_SRAM_SLEEP_B_ACK_LSB       (1U << 12)      /* 1b */
#define NETSYS_S_SRAM_PDN_LSB               (1U << 16)      /* 2b */
#define NETSYS_S_SRAM_PDN_ACK_LSB           (1U << 24)      /* 2b */
...
/* GCPU_SRAM_CON (0x10006000+0x3AC) */
#define GCPU_SRAM_CKISO_LSB                 (1U << 0)       /* 1b */
#define GCPU_SRAM_ISOINT_B_LSB              (1U << 1)       /* 1b */
#define GCPU_SRAM_SLEEP_B_LSB               (1U << 4)       /* 1b */
#define GCPU_SRAM_PDN_LSB                   (1U << 16)      /* 1b */
...
#define DRAMC_MCU_SRAM_PDN_ACK_LSB          (1U << 12)      /* 1b */
#define DRAMC_MCU_SRAM_SLEEP_B_ACK_LSB      (1U << 13)      /* 1b */
...
/* RC_SPMIF_CON (0x10006000+0x570) */
#define RC_SPMIF_WRITE_LSB                  (1U << 0)       /* 1b */
#define RC_SPMIF_ID_LSB                     (1U << 1)       /* 1b */
#define RC_SPMIF_CMD_LSB                    (1U << 2)       /* 2b */
#define RC_SPMIF_SLAIVEID_LSB               (1U << 4)       /* 4b */
#define RC_SPMIF_BYTE_CNT_LSB               (1U << 8)       /* 1b */
/* RC_SPMIF_RDATA (0x10006000+0x57C) */
#define RC_SPMIF_RDATA_LSB                  (1U << 0)       /* 16b */
