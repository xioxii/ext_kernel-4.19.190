...
#define RAEDMA_OFFSET		0x3800
#define RAEDMA1_OFFSET		0x3C00
...
#define EDMA_RELATED            0x3800
/* 2. EDMA */
#define TX_BASE_PTR0	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x000)
#define TX_MAX_CNT0	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x004)
#define TX_CTX_IDX0	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x008)
#define TX_DTX_IDX0	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x00C)

#define TX_BASE_PTR1	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x010)
#define TX_MAX_CNT1	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x014)
#define TX_CTX_IDX1	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x018)
#define TX_DTX_IDX1	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x01C)

#define TX_BASE_PTR2	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x020)
#define TX_MAX_CNT2	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x024)
#define TX_CTX_IDX2	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x028)
#define TX_DTX_IDX2	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x02C)

#define TX_BASE_PTR3	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x030)
#define TX_MAX_CNT3	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x034)
#define TX_CTX_IDX3	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x038)
#define TX_DTX_IDX3	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x03C)

#define RX_BASE_PTR0	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x100)
#define RX_MAX_CNT0	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x104)
#define RX_CALC_IDX0	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x108)
#define RX_DRX_IDX0	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x10C)

#define RX_BASE_PTR1	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x110)
#define RX_MAX_CNT1	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x114)
#define RX_CALC_IDX1	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x118)
#define RX_DRX_IDX1	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x11C)

#define RX_BASE_PTR2	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x120)
#define RX_MAX_CNT2	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x124)
#define RX_CALC_IDX2	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x128)
#define RX_DRX_IDX2	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x12C)

#define RX_BASE_PTR3	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x130)
#define RX_MAX_CNT3	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x134)
#define RX_CALC_IDX3	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x138)
#define RX_DRX_IDX3	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x13C)

#define EDMA_INFO	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x200)  // Stodo: What PDMA_INFO used for (all these whole section?)
#define EDMA_GLO_CFG	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x204)
#define EDMA_RST_IDX	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x208)
#define EDMA_RST_CFG	(EDMA_RST_IDX)
#define DLY_INT_CFG	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x20C)
#define FREEQ_THRES	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x210)
#define INT_STATUS	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x220)
#define FE_INT_STATUS	(INT_STATUS)
#define INT_MASK	(RALINK_FRAME_ENGINE_BASE + EDMA_RELATED + 0x228)
#define FE_INT_ENABLE	(INT_MASK)
#define SCH_Q01_CFG	(RALINK_FRAME_ENGINE_BASE + RAEDMA_OFFSET + 0x280)
#define SCH_Q23_CFG	(RALINK_FRAME_ENGINE_BASE + RAEDMA_OFFSET + 0x284)
// Share following define with PDMA because PAMA and EDMA won't exist simutaneously.
#define PDMA_INT_GRP1	(RALINK_FRAME_ENGINE_BASE + RAEDMA_OFFSET + 0x250)
#define PDMA_INT_GRP2	(RALINK_FRAME_ENGINE_BASE + RAEDMA_OFFSET + 0x254)
#define PDMA_INT_GRP3	(RALINK_FRAME_ENGINE_BASE + RAEDMA_OFFSET + 0x22c)

#define EDMA1_RELATED            0x3C00
/* 3. EDMA-1 */
#define TX_BASE_PTR0_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x000)
#define TX_MAX_CNT0_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x004)
#define TX_CTX_IDX0_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x008)
#define TX_DTX_IDX0_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x00C)

#define TX_BASE_PTR1_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x010)
#define TX_MAX_CNT1_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x014)
#define TX_CTX_IDX1_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x018)
#define TX_DTX_IDX1_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x01C)

#define TX_BASE_PTR2_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x020)
#define TX_MAX_CNT2_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x024)
#define TX_CTX_IDX2_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x028)
#define TX_DTX_IDX2_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x02C)

#define TX_BASE_PTR3_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x030)
#define TX_MAX_CNT3_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x034)
#define TX_CTX_IDX3_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x038)
#define TX_DTX_IDX3_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x03C)

#define RX_BASE_PTR0_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x100)
#define RX_MAX_CNT0_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x104)
#define RX_CALC_IDX0_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x108)
#define RX_DRX_IDX0_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x10C)

#define RX_BASE_PTR1_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x110)
#define RX_MAX_CNT1_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x114)
#define RX_CALC_IDX1_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x118)
#define RX_DRX_IDX1_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x11C)

#define RX_BASE_PTR2_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x120)
#define RX_MAX_CNT2_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x124)
#define RX_CALC_IDX2_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x128)
#define RX_DRX_IDX2_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x12C)

#define RX_BASE_PTR3_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x130)
#define RX_MAX_CNT3_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x134)
#define RX_CALC_IDX3_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x138)
#define RX_DRX_IDX3_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x13C)

#define EDMA_INFO_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x200)  // Stodo: What PDMA_INFO used for (all these whole section?)
#define EDMA_GLO_CFG_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x204)
#define EDMA_RST_IDX_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x208)
#define EDMA_RST_CFG_1	(EDMA_RST_IDX_1)
#define DLY_INT_CFG_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x20C)
#define FREEQ_THRES_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x210)
#define INT_STATUS_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x220)
#define FE_INT_STATUS_1	(INT_STATUS_1)
#define INT_MASK_1	(RALINK_FRAME_ENGINE_BASE + EDMA1_RELATED + 0x228)
#define FE_INT_ENABLE_1	(INT_MASK_1)

#define EDMA1_INT_GRP1	(RALINK_FRAME_ENGINE_BASE + RAEDMA1_OFFSET + 0x250)
#define EDMA1_INT_GRP2	(RALINK_FRAME_ENGINE_BASE + RAEDMA1_OFFSET + 0x254)
#define EDMA1_INT_GRP3	(RALINK_FRAME_ENGINE_BASE + RAEDMA1_OFFSET + 0x22c)
...
/*=========================================
 *    EDMA RX Descriptor Format define
 *=========================================
 */

struct EDMA_RXD_INFO1_T {
	unsigned int PDP0;
};

struct EDMA_RXD_INFO2_T {
	unsigned int RSV0:6;
	unsigned int RSV1:2;
...
struct EDMA_RXD_INFO4_T {
	unsigned int VID:16;
	unsigned int VPID:16;
};

struct EDMA_RXD_INFO5_T {
...
struct EDMA_RXD_INFO7_T {
	unsigned int RSV;
};

struct EDMA_RXD_INFO8_T {
	unsigned int RSV;
};

struct EDMA_rxdesc {
	struct EDMA_RXD_INFO1_T rxd_info1;
	struct EDMA_RXD_INFO2_T rxd_info2;
	struct EDMA_RXD_INFO3_T rxd_info3;
	struct EDMA_RXD_INFO4_T rxd_info4;
	struct EDMA_RXD_INFO5_T rxd_info5;
	struct EDMA_RXD_INFO6_T rxd_info6;
	struct EDMA_RXD_INFO7_T rxd_info7;
	struct EDMA_RXD_INFO8_T rxd_info8;
};

/*=========================================
 *    EDMA TX Descriptor Format define
 *=========================================
 */

struct EDMA_TXD_INFO1_T {
    unsigned int SDP0;
};

struct EDMA_TXD_INFO2_T {
    unsigned int RSV0:6;
    unsigned int RSV1:2;
...
struct EDMA_TXD_INFO3_T {
    unsigned int SDP1;
};

struct EDMA_TXD_INFO4_T {
    unsigned int RSV0:6;
    unsigned int RSV1:2;
...
struct EDMA_TXD_INFO7_T {
    unsigned int VLAN_TAG_0:16;
    unsigned int VPID_0:16;
};

struct EDMA_TXD_INFO8_T {
    unsigned int RSV;
};

struct EDMA_txdesc {
	struct EDMA_TXD_INFO1_T txd_info1;
	struct EDMA_TXD_INFO2_T txd_info2;
	struct EDMA_TXD_INFO3_T txd_info3;
	struct EDMA_TXD_INFO4_T txd_info4;
	struct EDMA_TXD_INFO5_T txd_info5;
	struct EDMA_TXD_INFO6_T txd_info6;
	struct EDMA_TXD_INFO7_T txd_info7;
	struct EDMA_TXD_INFO8_T txd_info8;
};

/*=========================================
 *    PDMA/EDMA TX and RX Descriptor size
 *=========================================
 */
#ifndef CONFIG_RAETH_EDMA
#define DMA_rxdesc_size    sizeof(struct PDMA_rxdesc)
#else
#define DMA_rxdesc_size    sizeof(struct EDMA_rxdesc)
#endif

#ifndef CONFIG_RAETH_EDMA
#define DMA_txdesc_size    sizeof(struct PDMA_txdesc)
#else
#define DMA_txdesc_size    sizeof(struct EDMA_txdesc)
#endif
...
#define PROCREG_PORT_STATUS	"port_status"
...
#else
#define DMA_GLO_CFG EDMA_GLO_CFG
#endif
#if defined(CONFIG_RAETH_EDMA)
#define GDMA1_FWD_PORT 0xBBBB /*for EDMA0 */
#define GDMA2_FWD_PORT 0xCCCC /*for EDMA1 */ //todo:0XCCCC for edma1, if only run edma0 needs to revise to 0xBBBB?
#elif defined(CONFIG_RAETH_QDMATX_QDMARX)
...
#define RAETH_RX_CALC_IDX0 QRX_CRX_IDX_0
#define RAETH_RX_CALC_IDX1 QRX_CRX_IDX_1
#elif defined(CONFIG_RAETH_EDMA_CONCURRENT)
#define RAETH_RX_CALC_IDX0 RX_CALC_IDX0
#define RAETH_RX_CALC_IDX1 RX_CALC_IDX1
#define RAETH_RX_CALC_IDX0_1 RX_CALC_IDX0_1
#define RAETH_RX_CALC_IDX1_1 RX_CALC_IDX1_1
#else
#define RAETH_RX_CALC_IDX0 RX_CALC_IDX0
#define RAETH_RX_CALC_IDX1 RX_CALC_IDX1
#endif
...
#define RAETH_FE_INT_STATUS_1 FE_INT_STATUS_1
#define RAETH_FE_INT_ENABLE_1 FE_INT_ENABLE_1
#define RAETH_DLY_INT_CFG_1 DLY_INT_CFG_1
#endif
