...
struct mboot_params_buffer {
	...
	uint32_t filling[4];
	uint64_t apv_md1rom_ba;
	uint64_t mdv_md1rom_ba;
	uint64_t apv_md_smem_cache_ba;
	uint64_t mdv_md_smem_cache_ba;
	uint64_t apv_md_smem_ncache_ba;
	uint64_t mdv_md_smem_ncache_ba;
};
