...
#define CCIF_TRAFFIC_MONITOR_INTERVAL 20
...
#ifdef M2_SERIAL_PRODUCT
int ccci_ccif_exception(unsigned char hif_id, enum HIF_EX_STAGE stage);
int ccci_ccif_ex_handshake(unsigned char md_id, unsigned char hif_id, enum HIF_EX_STAGE stage);
