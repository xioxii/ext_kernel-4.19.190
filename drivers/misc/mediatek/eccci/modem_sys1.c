...
#ifdef M2_SERIAL_PRODUCT
			ccci_ccif_reset(CCIF_HIF_ID, 0);
			ccci_ccif_reset(CCIF_HIF_ID, 1);
#else
#if (MD_GENERATION >= 6293)
...
#ifdef DEBUG_FOR_CCB
		ccci_hif_dump_status(1 << CCIF_HIF_ID, DUMP_FLAG_CCIF, NULL, 0);
#endif
	}
