...
struct mtu3_md_sync_data {
	struct usb_ctrlrequest *setup;
	usb_device_info_s_t *usb_device_info;
	usb_speed_enum_e speed;
	int tx_ep;
	int rx_ep;
};
...
struct mtu3 {
	...
	struct task_struct *md_msg_polling_tsk;
#else
	struct task_struct *isr_count_polling_tsk;
#endif
