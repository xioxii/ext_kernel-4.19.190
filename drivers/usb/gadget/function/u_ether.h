...
#define	WORK_RX_MEMORY		0
	...
	//rx profile
	long long rx_profile_ts;
	long long rx_profile_tput;
	long long rx_profile_packet_num;
	int rx_profile_max_rx_pending_num;
	int rx_profile_max_aggregation_num;

	//tx profile
	long long tx_profile_ts;
	long long tx_profile_tput;
	long long tx_profile_packet_num;
	int tx_profile_max_net_queue_num;
};
