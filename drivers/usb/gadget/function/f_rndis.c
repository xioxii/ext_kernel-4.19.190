...
static int rndis_aggregation = 1;
module_param(rndis_aggregation, uint, 0644);
MODULE_PARM_DESC (rndis_aggregation, "enable rndis_aggregation debugging");
