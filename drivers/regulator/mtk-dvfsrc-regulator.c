...
static const unsigned int mt6880_voltages[] = {
	550000,
	600000,
	650000,
	750000,
...
static struct dvfsrc_regulator mt6880_regulators[] = {
	MT_DVFSRC_REGULAR("dvfsrc-vcore", VCORE,
		mt6880_voltages),
};

static const struct dvfsrc_regulator_init_data regulator_mt6880_data = {
	.size = ARRAY_SIZE(mt6880_regulators),
	.regulator_info = &mt6880_regulators[0],
};
