...
static int ged_init(void)
{
	...
	ged_log_buf_alloc(1024, 64 * 1024,
		GED_LOG_BUF_TYPE_RINGBUFFER, "gpuinfo", "gpuinfo");
	...
	ghLogBuf_FWTrace =
		ged_log_buf_alloc(1024*32, 1024*1024,
		GED_LOG_BUF_TYPE_QUEUEBUFFER, "fw_trace", "fw_trace");
