						...
						void *cookie)
{
	...
	pr_notice("%s, %d, cf.ttbr=0x%x_%x,pgd_pa=0x%lx, quirks=0x%lx\n",
		  __func__, __LINE__, cfg->arm_v7s_cfg.ttbr[1],
		cfg->arm_v7s_cfg.ttbr[0], (unsigned long)phys_addr, cfg->quirks);
#endif
	return &data->iop;
