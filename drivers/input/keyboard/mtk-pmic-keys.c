...
#define MT6330_PWRKEY_RST_SHIFT		5
#define MT6330_HOMEKEY_RST_SHIFT	4
#define MT6330_RST_DU_SHIFT		6
...
static const struct mtk_pmic_regs mt6330_regs = {
	.keys_regs[MTK_PMIC_PWRKEY_INDEX] =
		MTK_PMIC_KEYS_REGS(INVALID_VALUE,
		INVALID_VALUE, MT6330_PSC_TOP_INT_CON0, 0x1),
	.release_irq = true,
	.pmic_rst_reg = MT6330_STRUP_CON12,
	.pwrkey_rst_shift = MT6330_PWRKEY_RST_SHIFT,
	.homekey_rst_shift = MT6330_HOMEKEY_RST_SHIFT,
	.rst_du_shift = MT6330_RST_DU_SHIFT,
};
		...
		const struct mtk_pmic_regs *pmic_regs)
{
	...
	u32 pwrkey_rst_du_mask, pwrkey_rst_du_val;
	...
	pwrkey_rst_du_mask = RST_DU_MASK << pmic_regs->rst_du_shift;
	pwrkey_rst_du_val = long_press_debounce << pmic_regs->rst_du_shift;
				...
				int irq, void *data)
{
	...
	pr_info("release key =%d using PMIC\n",
			info->keycode);
