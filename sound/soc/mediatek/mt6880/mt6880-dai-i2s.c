...
#define MTK_AFE_I2S4_KCONTROL_NAME "I2S4_HD_Mux"
...
#define I2S4_HD_EN_W_NAME "I2S4_HD_EN"
...
#define I2S4_MCLK_EN_W_NAME "I2S4_MCLK_EN"
			      ...
			      const char *name)
{
	if (strncmp(name, "I2S0", 4) == 0)
		return MT6880_DAI_I2S_0;
	else if (strncmp(name, "I2S1", 4) == 0)
		return MT6880_DAI_I2S_1;
	else if (strncmp(name, "I2S2", 4) == 0)
		return MT6880_DAI_I2S_2;
	else if (strncmp(name, "I2S3", 4) == 0)
		return MT6880_DAI_I2S_3;
	else if (strncmp(name, "I2S4", 4) == 0)
		return MT6880_DAI_I2S_4;
	else if (strncmp(name, "I2S5", 4) == 0)
		return MT6880_DAI_I2S_5;
	else if (strncmp(name, "I2S6", 4) == 0)
		return MT6880_DAI_I2S_6;
	else
		return -EINVAL;
}
...
/* low jitter control */
static const char * const mt6880_i2s_hd_str[] = {
	"Normal", "Low_Jitter"
};

static const struct soc_enum mt6880_i2s_enum[] = {
	SOC_ENUM_SINGLE_EXT(ARRAY_SIZE(mt6880_i2s_hd_str),
			    mt6880_i2s_hd_str),
};

static int mt6880_i2s_hd_get(struct snd_kcontrol *kcontrol,
...
static int mt6880_i2s_hd_set(struct snd_kcontrol *kcontrol,
			     struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static const struct snd_kcontrol_new mtk_dai_i2s_controls[] = {
	SOC_ENUM_EXT(MTK_AFE_I2S0_KCONTROL_NAME, mt6880_i2s_enum[0],
		     mt6880_i2s_hd_get, mt6880_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2S1_KCONTROL_NAME, mt6880_i2s_enum[0],
		     mt6880_i2s_hd_get, mt6880_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2S2_KCONTROL_NAME, mt6880_i2s_enum[0],
		     mt6880_i2s_hd_get, mt6880_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2S3_KCONTROL_NAME, mt6880_i2s_enum[0],
		     mt6880_i2s_hd_get, mt6880_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2S4_KCONTROL_NAME, mt6880_i2s_enum[0],
		     mt6880_i2s_hd_get, mt6880_i2s_hd_set),		     
	SOC_ENUM_EXT(MTK_AFE_I2S5_KCONTROL_NAME, mt6880_i2s_enum[0],
		     mt6880_i2s_hd_get, mt6880_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2S6_KCONTROL_NAME, mt6880_i2s_enum[0],
		     mt6880_i2s_hd_get, mt6880_i2s_hd_set),
};
...
static SOC_VALUE_ENUM_SINGLE_AUTODISABLE_DECL(i2s0_lpbk_mux_map_enum,
					      AFE_I2S_LPBK_CFG,
					      I2S0_DAT_LPBK_SEL_SFT,
					      I2S0_DAT_LPBK_SEL_MASK,
					      i2s_lpbk_mux_map,
...
static SOC_VALUE_ENUM_SINGLE_AUTODISABLE_DECL(i2s4_lpbk_mux_map_enum,
					      AFE_I2S_LPBK_CFG,
					      I2S4_DAT_LPBK_SEL_SFT,
					      I2S4_DAT_LPBK_SEL_MASK,
					      i2s_lpbk_mux_map,
					      i2s_lpbk_mux_map_value);

static const struct snd_kcontrol_new i2s4_lpbk_mux_control =
	SOC_DAPM_ENUM("I2S Lpbk Select", i2s4_lpbk_mux_map_enum);

static SOC_VALUE_ENUM_SINGLE_AUTODISABLE_DECL(i2s6_lpbk_mux_map_enum,
					      AFE_I2S_LPBK_CFG,
					      I2S6_DAT_LPBK_SEL_SFT,
					      I2S6_DAT_LPBK_SEL_MASK,
					      i2s_lpbk_mux_map,
					      i2s_lpbk_mux_map_value);

static const struct snd_kcontrol_new i2s6_lpbk_mux_control =
	SOC_DAPM_ENUM("I2S Lpbk Select", i2s6_lpbk_mux_map_enum);
			       ...
			       int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		mt6880_afe_gpio_request(afe, true, i2s_priv->id, 0);
		break;
	case SND_SOC_DAPM_POST_PMD:
		mt6880_afe_gpio_request(afe, false, i2s_priv->id, 0);
		break;
	default:
		break;
	}
			     ...
			     int event)
{
	...
	switch (event) {
	case SND_SOC_DAPM_PRE_PMU:
		mt6880_mck_enable(afe, i2s_priv->mclk_id, i2s_priv->mclk_rate);
		break;
	case SND_SOC_DAPM_POST_PMD:
		i2s_priv->mclk_rate = 0;
		mt6880_mck_disable(afe, i2s_priv->mclk_id);
		break;
	default:
		break;
	}
...
static const struct snd_soc_dapm_widget mtk_dai_i2s_widgets[] = {
	...
	SND_SOC_DAPM_SUPPLY_S("I2S3_EN", SUPPLY_SEQ_I2S_EN,
			      ...
			      mtk_i2s_en_event,
			      SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMD),
	SND_SOC_DAPM_SUPPLY_S("I2S4_EN", SUPPLY_SEQ_I2S_EN,
				  AFE_I2S_CON4, I2S4_EN_SFT, 0,
				  mtk_i2s_en_event,
				  SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMD),
	SND_SOC_DAPM_SUPPLY_S("I2S5_EN", SUPPLY_SEQ_I2S_EN,
				  AFE_I2S_CON5, I2S5_EN_SFT, 0,
				  mtk_i2s_en_event,
				  SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMD),
	...
	SND_SOC_DAPM_SUPPLY_S(I2S3_HD_EN_W_NAME, SUPPLY_SEQ_I2S_HD_EN,
			      ...
			      mtk_i2s_hd_en_event,
			      SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMD),
	SND_SOC_DAPM_SUPPLY_S(I2S4_HD_EN_W_NAME, SUPPLY_SEQ_I2S_HD_EN,
			      AFE_I2S_CON4, I2S4_HD_EN_SFT, 0,
			      mtk_i2s_hd_en_event,
			      SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMD),
	SND_SOC_DAPM_SUPPLY_S(I2S5_HD_EN_W_NAME, SUPPLY_SEQ_I2S_HD_EN,
			      AFE_I2S_CON5, I2S5_HD_EN_SFT, 0,
			      mtk_i2s_hd_en_event,
			      SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMD),
	...
	SND_SOC_DAPM_SUPPLY_S(I2S3_MCLK_EN_W_NAME, SUPPLY_SEQ_I2S_MCLK_EN,
			      ...
			      mtk_mclk_en_event,
			      SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMD),
	SND_SOC_DAPM_SUPPLY_S(I2S4_MCLK_EN_W_NAME, SUPPLY_SEQ_I2S_MCLK_EN,
				  SND_SOC_NOPM, 0, 0,
				  mtk_mclk_en_event,
				  SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMD),
	...
	SND_SOC_DAPM_MUX("I2S4_Lpbk_Mux",
			 SND_SOC_NOPM, 0, 0, &i2s4_lpbk_mux_control),
	SND_SOC_DAPM_MUX("I2S6_Lpbk_Mux",
			 SND_SOC_NOPM, 0, 0, &i2s6_lpbk_mux_control),
};
/*end: modify audio codec function,by laizhenhao,2021.05.31*/
				    ...
				    struct snd_soc_dapm_widget *sink)
{
	...
	i2s_need_apll = mt6880_get_apll_by_rate(afe, i2s_priv->rate);
...
/*end: modify audio codec function,by laizhenhao,2021.05.31*/
	...
	{"I2S0", NULL, "I2S4_EN", mtk_afe_i2s_share_connect},
	...
	{"I2S0", NULL, I2S4_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
	...
	{"I2S0", NULL, I2S4_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
	...
	{"I2S1", NULL, "I2S4_EN", mtk_afe_i2s_share_connect},
	...
	{"I2S1", NULL, I2S4_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
	...
	{"I2S1", NULL, I2S4_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
	...
	{"I2S2", NULL, "I2S4_EN", mtk_afe_i2s_share_connect},
	...
	{"I2S2", NULL, I2S4_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
	...
	{"I2S2", NULL, I2S4_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
	...
	{"I2S3", NULL, "I2S3_EN"},
	{"I2S3", NULL, "I2S4_EN", mtk_afe_i2s_share_connect},
	...
	{"I2S3", NULL, I2S4_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
	...
	{"I2S3", NULL, I2S4_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
	...
	/* i2s4 */
	{"I2S4", NULL, "I2S0_EN", mtk_afe_i2s_share_connect},
	{"I2S4", NULL, "I2S1_EN", mtk_afe_i2s_share_connect},
	{"I2S4", NULL, "I2S2_EN", mtk_afe_i2s_share_connect},
	{"I2S4", NULL, "I2S3_EN", mtk_afe_i2s_share_connect},
	{"I2S4", NULL, "I2S4_EN"},
	{"I2S4", NULL, "I2S5_EN", mtk_afe_i2s_share_connect},
	{"I2S4", NULL, "I2S6_EN", mtk_afe_i2s_share_connect},
	
	{"I2S4", NULL, I2S0_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
	{"I2S4", NULL, I2S1_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
	{"I2S4", NULL, I2S2_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
	{"I2S4", NULL, I2S3_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
	{"I2S4", NULL, I2S4_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
	{"I2S4", NULL, I2S5_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
	{"I2S4", NULL, I2S6_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
	{I2S4_HD_EN_W_NAME, NULL, APLL1_W_NAME, mtk_afe_i2s_apll_connect},
	{I2S4_HD_EN_W_NAME, NULL, APLL2_W_NAME, mtk_afe_i2s_apll_connect},
	
	{"I2S4", NULL, I2S0_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
	{"I2S4", NULL, I2S1_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
	{"I2S4", NULL, I2S2_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
	{"I2S4", NULL, I2S3_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
	{"I2S4", NULL, I2S4_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
	{"I2S4", NULL, I2S5_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
	{"I2S4", NULL, I2S6_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
	{I2S4_MCLK_EN_W_NAME, NULL, APLL1_W_NAME, mtk_afe_mclk_apll_connect},
	{I2S4_MCLK_EN_W_NAME, NULL, APLL2_W_NAME, mtk_afe_mclk_apll_connect},
	...
	{"I2S5", NULL, "I2S4_EN", mtk_afe_i2s_share_connect},
	{"I2S5", NULL, "I2S5_EN"},
	...
	{"I2S5", NULL, I2S4_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
	...
	{"I2S5", NULL, I2S4_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
	...
	{"I2S6", NULL, "I2S4_EN", mtk_afe_i2s_share_connect},
	...
	{"I2S6", NULL, I2S4_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
	...
	{"I2S6", NULL, I2S4_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
	...
	{"I2S4_Lpbk_Mux", "Lpbk", "I2S5"},
	{"I2S6_Lpbk_Mux", "Lpbk", "I2S5"},
	{"I2S0", NULL, "I2S0_Lpbk_Mux"},
	{"I2S2", NULL, "I2S2_Lpbk_Mux"},
	{"I2S4", NULL, "I2S4_Lpbk_Mux"},
	{"I2S6", NULL, "I2S6_Lpbk_Mux"},
};
					 ...
					 struct snd_soc_dai *dai)
{
	...
	unsigned int rate_reg = mt6880_rate_transform(afe->dev,
						      rate, dai->id);
				       ...
				       int cmd, struct snd_soc_dai *dai)
{
	struct mtk_base_afe *afe = snd_soc_dai_get_drvdata(dai);
	struct mt6880_afe_private *afe_priv = afe->platform_priv;
	unsigned int need_disable_asm = 0;
				  ...
				  int clk_id, unsigned int freq, int dir)
{
	...
	apll = mt6880_get_apll_by_rate(afe, freq);
	apll_rate = mt6880_get_apll_rate(afe, apll);
...
static const struct mtk_afe_i2s_priv mt6880_i2s_priv[DAI_I2S_NUM] = {
	[DAI_I2S0] = {
		.id = MT6880_DAI_I2S_0,
		.mclk_id = MT6880_I2S0_MCK,
		.share_property_name = "i2s0-share",
		.share_i2s_id = -1,
	},
	[DAI_I2S1] = {
		.id = MT6880_DAI_I2S_1,
		.mclk_id = MT6880_I2S1_MCK,
		.share_property_name = "i2s1-share",
		.share_i2s_id = -1,
	},
	[DAI_I2S2] = {
		.id = MT6880_DAI_I2S_2,
		.mclk_id = MT6880_I2S2_MCK,
	...
	[DAI_I2S4] = {
		.id = MT6880_DAI_I2S_4,
		.mclk_id = MT6880_I2S4_MCK,
		.share_property_name = "i2s4-share",
		.share_i2s_id = -1,
	},
	[DAI_I2S5] = {
		.id = MT6880_DAI_I2S_5,
		.mclk_id = MT6880_I2S5_MCK,
		.share_property_name = "i2s5-share",
		.share_i2s_id = -1,
	},
	[DAI_I2S6] = {
		.id = MT6880_DAI_I2S_6,
		.mclk_id = MT6880_I2S6_MCK,
		.share_property_name = "i2s6-share",
		.share_i2s_id = -1,
	},
};

int mt6880_dai_i2s_get_share(struct mtk_base_afe *afe)
{
	struct mt6880_afe_private *afe_priv = afe->platform_priv;
	...
	for (i = 0; i < DAI_I2S_NUM; i++) {
		i2s_priv = afe_priv->dai_priv[mt6880_i2s_priv[i].id];
		property_name = mt6880_i2s_priv[i].share_property_name;
...
int mt6880_dai_i2s_set_priv(struct mtk_base_afe *afe)
{
	int i;
	int ret;

	for (i = 0; i < DAI_I2S_NUM; i++) {
		ret = mt6880_dai_set_priv(afe, mt6880_i2s_priv[i].id,
...
int mt6880_dai_i2s_register(struct mtk_base_afe *afe)
{
	...
	ret = mt6880_dai_i2s_set_priv(afe);
	if (ret)
		return ret;

	/* parse share i2s */
	ret = mt6880_dai_i2s_get_share(afe);
	if (ret)
		return ret;
