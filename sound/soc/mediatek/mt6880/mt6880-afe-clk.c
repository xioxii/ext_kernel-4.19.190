...
static const char *aud_clks[CLK_NUM] = {
	...
	[CLK_TOP_APLL12_DIVM] = "top_apll12_divm",
...
static int mt6880_set_audio_int_bus_parent(struct mtk_base_afe *afe,
					   int clk_id)
{
...
int mt6880_afe_enable_clock(struct mtk_base_afe *afe)
{
	struct mt6880_afe_private *afe_priv = afe->platform_priv;
	int ret = 0;
	...
	ret = mt6880_set_audio_int_bus_parent(afe,
					      CLK_CLK26M);
	if (ret)
...
void mt6880_afe_disable_clock(struct mtk_base_afe *afe)
{
	struct mt6880_afe_private *afe_priv = afe->platform_priv;
	...
	mt6880_set_audio_int_bus_parent(afe, CLK_CLK26M);
	clk_disable_unprepare(afe_priv->clk[CLK_MUX_AUDIOINTBUS]);
	clk_disable_unprepare(afe_priv->clk[CLK_MUX_AUDIO]);
...
int mt6880_afe_suspend_clock(struct mtk_base_afe *afe)
{
	struct mt6880_afe_private *afe_priv = afe->platform_priv;
	int ret;
	...
	ret = mt6880_set_audio_int_bus_parent(afe, CLK_CLK26M);
...
int mt6880_afe_resume_clock(struct mtk_base_afe *afe)
{
	struct mt6880_afe_private *afe_priv = afe->platform_priv;
	int ret;
...
int mt6880_afe_dram_request(struct device *dev)
{
...
int mt6880_afe_dram_release(struct device *dev)
{
	struct mtk_base_afe *afe = dev_get_drvdata(dev);
	struct mt6880_afe_private *afe_priv = afe->platform_priv;
/*	struct arm_smccc_res res;*/
...
int mt6880_apll1_enable(struct mtk_base_afe *afe)
{
	struct mt6880_afe_private *afe_priv = afe->platform_priv;
	int ret;
...
void mt6880_apll1_disable(struct mtk_base_afe *afe)
{
	struct mt6880_afe_private *afe_priv = afe->platform_priv;
...
int mt6880_apll2_enable(struct mtk_base_afe *afe)
{
	struct mt6880_afe_private *afe_priv = afe->platform_priv;
	int ret;
...
void mt6880_apll2_disable(struct mtk_base_afe *afe)
{
	struct mt6880_afe_private *afe_priv = afe->platform_priv;
...
int mt6880_get_apll_rate(struct mtk_base_afe *afe, int apll)
{
	return (apll == MT6880_APLL1) ? 180633600 : 196608000;
}

int mt6880_get_apll_by_rate(struct mtk_base_afe *afe, int rate)
{
	return ((rate % 8000) == 0) ? MT6880_APLL2 : MT6880_APLL1;
}

int mt6880_get_apll_by_name(struct mtk_base_afe *afe, const char *name)
{
...
/* mck */
struct mt6880_mck_div {
	int m_sel_id;
	int div_clk_id;
};

static const struct mt6880_mck_div mck_div[MT6880_MCK_NUM] = {
	[MT6880_I2S0_MCK] = {
	...
	[MT6880_TDM_MCK] = {
		...
		.div_clk_id = CLK_TOP_APLL12_DIVM,
	},
	[MT6880_TDM_BCK] = {
		.m_sel_id = -1,
...
int mt6880_mck_enable(struct mtk_base_afe *afe, int mck_id, int rate)
{
	struct mt6880_afe_private *afe_priv = afe->platform_priv;
	int apll = mt6880_get_apll_by_rate(afe, rate);
	int apll_clk_id = apll == MT6880_APLL1 ?
...
void mt6880_mck_disable(struct mtk_base_afe *afe, int mck_id)
{
	struct mt6880_afe_private *afe_priv = afe->platform_priv;
	int m_sel_id = mck_div[mck_id].m_sel_id;
	int div_clk_id = mck_div[mck_id].div_clk_id;
...
int mt6880_init_clock(struct mtk_base_afe *afe)
{
	struct mt6880_afe_private *afe_priv = afe->platform_priv;
	int i = 0;
