...
/*begin: modify by laizhenhao for I2S PCM GPIO*/
enum mt6880_afe_gpio {
	MT6880_AFE_GPIO_DAT_MISO_OFF,
	MT6880_AFE_GPIO_DAT_MISO_ON,
	MT6880_AFE_GPIO_DAT_MOSI_OFF,
	MT6880_AFE_GPIO_DAT_MOSI_ON,
	...
	MT6880_AFE_GPIO_VOW_DAT_OFF,
	MT6880_AFE_GPIO_VOW_DAT_ON,
	MT6880_AFE_GPIO_VOW_CLK_OFF,
	MT6880_AFE_GPIO_VOW_CLK_ON,
...
/*end: modify by laizhenhao for audio gpio*/
...
static struct audio_gpio_attr aud_gpios[MT6880_AFE_GPIO_GPIO_NUM] = {
	[MT6880_AFE_GPIO_DAT_MISO_OFF] = {"aud_dat_miso_off", false, NULL},
	[MT6880_AFE_GPIO_DAT_MISO_ON] = {"aud_dat_miso_on", false, NULL},
	[MT6880_AFE_GPIO_DAT_MOSI_OFF] = {"aud_dat_mosi_off", false, NULL},
	[MT6880_AFE_GPIO_DAT_MOSI_ON] = {"aud_dat_mosi_on", false, NULL},
	...
	[MT6880_AFE_GPIO_VOW_DAT_OFF] = {"vow_dat_miso_off", false, NULL},
	[MT6880_AFE_GPIO_VOW_DAT_ON] = {"vow_dat_miso_on", false, NULL},
	[MT6880_AFE_GPIO_VOW_CLK_OFF] = {"vow_clk_miso_off", false, NULL},
	[MT6880_AFE_GPIO_VOW_CLK_ON] = {"vow_clk_miso_on", false, NULL},
...
static int mt6880_afe_gpio_adda_dl(struct mtk_base_afe *afe, bool enable)
{
	if (enable)
		return mt6880_afe_gpio_select(afe,
					      MT6880_AFE_GPIO_DAT_MOSI_ON);
	else
		return mt6880_afe_gpio_select(afe,
					      MT6880_AFE_GPIO_DAT_MOSI_OFF);
...
static int mt6880_afe_gpio_adda_ul(struct mtk_base_afe *afe, bool enable)
{
	if (enable)
		return mt6880_afe_gpio_select(afe,
					      MT6880_AFE_GPIO_DAT_MISO_ON);
			    ...
			    int dai, int uplink)
{
	...
	switch (dai) {
	case MT6880_DAI_ADDA:
		if (uplink)
			mt6880_afe_gpio_adda_ul(afe, enable);
		else
			mt6880_afe_gpio_adda_dl(afe, enable);
		break;
...
/*end: modify by laizhenhao for I2S PCM GPIO*/
	default:
