...
#include "../../codecs/sma1301.h"
#endif

/*begin: modify audio codec function,by laizhenhao,2021.05.31*/
#if defined(CONFIG_SND_SOC_NAU88C22)
#include "../../codecs/fibo_nau88c22.h"
#endif/* CONFIG_SND_SOC_NAU88C22 */
...
#ifdef CONFIG_SND_SOC_SMA1301
	[MTK_SPK_SILICON_SM1301] = {
		.i2c_probe = sma1301_i2c_probe,
		.i2c_remove = sma1301_i2c_remove,
		.codec_dai_name = "sma1301-amplifier",
		.codec_name = "sma1301.0-001e",
	},
#endif /* CONFIG_SND_SOC_SMA1301 */
#if defined(CONFIG_SND_SOC_RT5509)
...
#ifdef CONFIG_SND_SOC_NAU88C22
	[MTK_SPK_NUVOTON_NAU88C22] = {
		.i2c_probe = nau88c22_i2c_probe,
		.i2c_remove = nau88c22_i2c_remove,
		.codec_dai_name = "nau88c22-hifi",
		.codec_name = "nau88c22.0-001a",
	},
#endif /* CONFIG_SND_SOC_NAU88C22 */
